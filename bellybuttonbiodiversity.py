...
# Route to get the list of sample names 
...
# Route to get the metadata for a specific sample
...
# Route to get the washing frequency for a specific sample
...
# Route to get the otu_id's and corresponding sample count in descending order 
